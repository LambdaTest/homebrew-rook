...
check "(a) root_url set correctly" \
      ...
      grep -qF "    root_url \"https://github.com/LambdaTest/homebrew-rook/releases/download/rook-${VERSION_A}\"" \
...
check "(b) new root_url reflects the bumped version" \
      ...
      grep -qF "    root_url \"https://github.com/LambdaTest/homebrew-rook/releases/download/rook-${VERSION_B}\"" \
